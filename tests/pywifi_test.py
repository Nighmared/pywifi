...
def test_profile_comparison():
    ...
    profile1.auth = const.Auth.OPEN
    profile1.akm.append(const.AKM.WPA2PSK)
    profile1.cipher = const.Cipher.CCMP
    profile1.key = '12345678'

    profile2 = pywifi.Profile()
    profile2.ssid = 'testap'
    profile2.auth = const.Auth.OPEN
    profile2.akm.append(const.AKM.WPA2PSK)
    profile2.cipher = const.Cipher.CCMP
    ...
    profile3.auth = const.Auth.OPEN
    profile3.akm.append(const.AKM.WPAPSK)
    profile3.cipher = const.Cipher.CCMP
...
def test_add_network_profile():
    ...
    profile.ssid = 'testap'
    profile.auth = const.Auth.OPEN
    profile.akm.append(const.AKM.WPA2PSK)
    profile.cipher = const.Cipher.CCMP
    ...
    assert const.AKM.WPA2PSK in profiles[0].akm
    assert const.Auth.OPEN == profiles[0].auth
...
def test_remove_network_profile():
    ...
    profile3.auth = const.Auth.OPEN
    profile3.akm.append(const.AKM.WPAPSK)
    profile3.cipher = const.Cipher.TKIP
    profile3.key = '12345678'
...
def test_status():
    ...
    assert iface.status() in\
        [const.Iface.DISCONNECTED, const.Iface.INACTIVE]
...
def test_connect():
    ...
    time.sleep(5)
    assert iface.status() == const.Iface.CONNECTED
...
def test_connect_open():
    ...
    profile.ssid = 'testap'
    profile.auth = const.Auth.OPEN
    profile.akm.append(const.AKM.NONE)
